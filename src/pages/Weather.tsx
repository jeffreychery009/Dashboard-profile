    ...
    <>
      <div>
        <div className="bg-white p-5 m-5 shadow-md rounded-lg max-w-80 ">
          <h1 className="text-xl font-medium">View the Weather</h1>
      ...
      <div className="max-w-sm mx-auto bg-white p-6 rounded-lg shadow-lg flex flex-col items-center space-y-4">
        <span className="text-xl font-medium text-gray-400">Your Location</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {weather?.map((city) => (
            ...
            >
              ...
              <div className="text-lg text-gray-500">{city.condition}</div>
              <div className="flex justify-between w-full text-sm text-gray-600">
